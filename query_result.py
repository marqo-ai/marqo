...
#This presents whether the search results were obtained under less-than-ideal conditions.
...
#Method to access hits (documents which are appropriate for the query)
    @property
