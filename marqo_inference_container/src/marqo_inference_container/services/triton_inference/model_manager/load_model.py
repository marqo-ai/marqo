...
def load_model(
        ...
        model_manager: TritonModelManager, model_auth= None,
    ) -> AbstractEmbeddingModel:
    """
...
def _update_available_models(model_cache_key: str, model_name: str, validated_model_properties: dict,
                             triton_client: TritonGRPCClient, model_manager: TritonModelManager,
                             model_auth = None,) -> None:
...
def _load_model(
        ...
        model_manager: TritonModelManager, triton_client: TritonGRPCClient,
        model_auth= None
) -> Any:
    """_summary_
...
# class TritonTritonModelManager(TritonModelManager):
#     """
