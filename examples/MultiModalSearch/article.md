...
We can now define mappings objects to determine how we want to combnine the different fields. We can then index the documents.
...
To get the vectors to use as context vectors at search time - we need to retrieve the just calcualted representations. We can then create a context object that is used at search time.
