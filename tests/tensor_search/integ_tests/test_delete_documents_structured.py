...
class TestDeleteDocumentsStructured(MarqoTestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        text_index_with_random_model_request = cls.structured_marqo_index_request(
    ...
    def test_delete_documents(self):
        ...
        add_docs_caller(
            ...
            docs=[
                ...
                {"field1": "cat dog sat mat", "field2": "Australia contains Sydney", "_id": "at-at"}
            ])
