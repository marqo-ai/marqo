...
class TestMultimodalTensorCombination(MarqoTestCase):
            ...
            with self.subTest(f"Index type: {index.type}. Index name: {index.name}"):
                    ...
                    index_name=index.name, docs=[
                        {
                            ...
                            "image_field_2": TEST_IMAGE_URLS['image2'],
                            "_id": "c1"
                        },
                        {
                            "text_field_1": "A rider is riding a horse jumping over the barrier.",
                ...
                tensor_search.add_documents(config=self.config, add_docs_params=AddDocsParams(
                    index_name=index.name, docs=[
                        ...
                        {
                            "image_field_3": TEST_IMAGE_URLS['image1'],
                            "_id": "3"
                        },
                        {
                            "image_field_4": TEST_IMAGE_URLS['image2'],
                            "_id": "4"
                        }],
    ...
    def test_multimodal_tensor_combination_zero_weight(self):
        for index in [self.unstructured_multimodal_index, self.structured_multimodal_index]:
            with self.subTest(f"Index type: {index.type}. Index name: {index.name}"):
                ...
                score_2 = get_score({
                    "zero_weight_text_field": "A rider is riding a horse jumping over the barrier.",
                    "zero_weight_image_field": TEST_IMAGE_URLS['image1'],
                    "_id": "1"
                })
        ...
        def run():
            tensor_search.add_documents(config=self.config, add_docs_params=AddDocsParams(
                index_name=self.unstructured_random_multimodal_index.name, docs=[
                    ...
                    {  # a normal doc
                        "combo_text_image": TEST_IMAGE_URLS['image2'],
                        "_id": "534",
                    }],
                mappings={
                    "combo_text_image": {
                        ...
                        index_name=index.name, docs=[
                            {
                                ...
                                "image_field_1": TEST_IMAGE_URLS['image1'],
                                "image_field_2": TEST_IMAGE_URLS['image2'],
                                "image_field_3": TEST_IMAGE_URLS['image3'],
                                "image_field_4": TEST_IMAGE_URLS['image4'],
                                "_id": "111",
                            }],
                ...
                index_name=self.unstructured_random_multimodal_index.name, docs=[
                    {
                        ...
                        "image_0": TEST_IMAGE_URLS['image0'],
                        "image_1": TEST_IMAGE_URLS['image1'],
                        "image_2": TEST_IMAGE_URLS['image2'],
                        "image_3": TEST_IMAGE_URLS['image3'],
                        "image_4": TEST_IMAGE_URLS['image4'],
                        "_id": "111",
                    }],
                mappings={
            ...
            index_name=self.unstructured_multimodal_index.name, docs=[
                {
                    ...
                    "_id": "article_591",
                    "Genre": "Science",
                    "my_image": TEST_IMAGE_URLS['image4'],
            ...
            index_name=self.unstructured_multimodal_index.name, docs=[
                {
                    ...
                    "_id": "article_592",
                    "Genre": "text",
                    "my_image_1": TEST_IMAGE_URLS['image4'],
    ...
    def test_multimodal_combination_chunks(self):
        ...
        for index in [self.unstructured_random_multimodal_index]:
            with self.subTest(f"Index type: {index.type}. Index name: {index.name}"):
                test_doc = {
                    "image_field": TEST_IMAGE_URLS['image4'],
