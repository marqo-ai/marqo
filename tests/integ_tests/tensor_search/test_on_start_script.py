...
class TestOnStartScript(MarqoTestCase):
    ...
    def test_preload_url_models(self):
        ...
        environ_expected_models = [
            ({enums.EnvVars.MARQO_MODELS_TO_PRELOAD: json.dumps([clip_model_object, open_clip_model_object])},
    ...
    def test_preload_patch_models(self):
        valid_patch_models = ['simple', 'overlap', 'fastercnn', 'frcnn', 'marqo-yolo', 'yolox', 'dino-v1', 'dino-v2',
                              'dino/v1', 'dino/v2']
