...
from marqo.core.unstructured_vespa_index.unstructured_document import (
...
class TestDictScoreModifiers(MarqoTestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        structured_default_text_index = cls.structured_marqo_index_request(
            ...
            fields=[
                ...
                FieldRequest(
                    name="double_score_mods",
                    type=FieldType.Double,
                    features=[FieldFeature.ScoreModifier],
                ),
                FieldRequest(
                    name="float_score_mods",
                ...
                FieldRequest(
                    ...
                    type=FieldType.MapInt,
                    features=[FieldFeature.ScoreModifier],
                ),
                FieldRequest(
                    name="map_score_mods_long",
                    type=FieldType.MapLong,
                    features=[FieldFeature.ScoreModifier],
                ),
                FieldRequest(
        ...
        cls.indexes = cls.create_indexes(
            [unstructured_default_text_index, structured_default_text_index]
        )
                        ...
                        docs=[
                            {
                                ...
                                "double_score_mods": 0.5 * 1**39,
                            },
                            {
                                "_id": "2",
                                "text_field": "a photo of a cat",
                                "double_score_mods": 4.5 * 1**39,
                            },
                            {
                                "_id": "3",
                                "text_field": "a photo of a cat",
                                "double_score_mods": 5.5 * 1**39,
                            },
    ...
    def test_long_score_modifier(self):
        ...
        for index in [self.structured_default_text_index]:
            with self.subTest(index=index.type):
                        ...
                        docs=[
                            {
                                "_id": "1",
                                "text_field": "a photo of a cat",
                                "score_mods_long": 2**34,
                            },
                            {
                                "_id": "2",
                                "text_field": "a photo of a cat",
                                "score_mods_long": 2**35,
                            },
                            {
                                "_id": "3",
                                "text_field": "a photo of a cat",
                                "score_mods_long": 2**36,
                            },
                            {"_id": "4", "text_field": "a photo of a cat"},
                        ],
                    ),
                ...
                # 0.5 + 2**36 * 2 = 2**37
                score_modifier = ScoreModifierLists(
                    **{"add_to_score": [{"field_name": "score_mods_long", "weight": 2}]}
                )
                res = tensor_search.search(
                    index_name=index.name,
                    config=self.config,
        ...
        for index in [
            ...
            with self.subTest(index=index.type):
                ...
                res = self.add_documents(
                    ...
                    add_docs_params=AddDocsParams(
                        ...
                        docs=[
                            ...
                            {
                                "_id": "2",
                                "text_field": "a photo of a dog",
                                "map_score_mods": {"b": 0.5},
                            },
                            {
                                "_id": "3",
                                "text_field": "a photo of a cat",
                                "map_score_mods": {"c": 0.5},
                            },
                            {
                                "_id": "4",
                                "text_field": "a photo of a cat",
                ...
                score_modifier = ScoreModifierLists(
                    **{
                        "add_to_score": [
                            {"field_name": "map_score_mods_int.c", "weight": 5}
                        ]
                    }
                )
                res = tensor_search.search(
    ...
    @unittest.skip(
        reason="temporarily skip due to inference interface change: random model changed"
    )
        ...
        for index in [
            ...
            with self.subTest(index=index.type):
                ...
                score_modifier = ScoreModifierLists(
                    **{
                        "multiply_score_by": [
                            {"field_name": "map_score_mods.a", "weight": 4},
                            {"field_name": "map_score_mods.d", "weight": 4},
                        ]
                    }
                )  # Nonexistent field.
        ...
        for index in [
            ...
            with self.subTest(index=index.type):
                ...
                score_modifier = ScoreModifierLists(
                    **{
                        "add_to_score": [
                            {"field_name": "map_score_mods_int.c", "weight": 2}
                        ],
                        "multiply_score_by": [
                            {"field_name": "map_score_mods.a", "weight": 4}
                        ],
        ...
        for index in [
            ...
            with self.subTest(index=index.type):
                        ...
                        docs=[
                            {
                                "_id": "1",
                                "text_field": "a photo of a cat",
                                "map_score_mods_long": {"a": 4294967295012},
                            },
                            {
                                "_id": "2",
                                "text_field": "a photo of a cat",
                                "score_mods_long": 4294967295012,
                            },
                            {
                                "_id": "4",
                                "text_field": "a photo of a cat",
                ...
                score_modifier = ScoreModifierLists(
                    **{
                        "add_to_score": [
                            {"field_name": "map_score_mods_long.a", "weight": 20},
                ...
                self.assertTrue(
                    85899345900239 <= score_of_first_result <= 85899345900241
                )
                self.assertTrue(
                    85899345900239 <= score_of_second_result <= 85899345900241
                )
    ...
    def test_unstructured_unsupported_map_error(self):
        ...
        for index in [self.unstructured_default_text_index]:
            with self.subTest(index=index.type):
                ...
                self.assertIn(
                    expected_doc_3_error["invalid_argument"],
                    actual_doc3["invalid_argument"],
                )
        ...
        for index in [self.unstructured_default_text_index]:
            with self.subTest(index=index.type):
                ...
                expected_results = {
                    "1": {
                        "status": 400,
                        "error": "in map field is not of type int or float",
                ...
                for item in actual_results:
                    ...
                    with self.subTest(doc_id=doc_id):
                        ...
                        if expected["status"] == 400:
                            ...
                            self.assertIn(
                                "_id", item, f"Document {doc_id} missing _id field"
                            )

                actual_statuses = {item["_id"]: item["status"] for item in res["items"]}
                expected_statuses = {
                    id: data["status"] for id, data in expected_results.items()
                }
                self.assertEqual(
                    expected_statuses,
                    actual_statuses,
                    "Overall status results mismatch",
                )
                            ...
                            docs=[
                                {
                                    ...
                                    "text2": "hello",
                                    "my_int": 2,
                                    "my_custom_audio_vector_1": {"vector": 24},
                                },
                            ],
    ...
    def test_structured_tensor_storage_old_and_new(self):
        ...
        self.assertEqual(
            vespa_doc["fields"]["marqo__score_modifiers_float"]["float_field"], 1.23
        )
        self.assertEqual(
            vespa_doc["fields"]["marqo__score_modifiers_float"][
                "map_float_field.float_field"
            ],
            1.23,
        )
        self.assertEqual(
            vespa_doc["fields"]["marqo__score_modifiers_double_long"]["double_field"],
            4.56,
        )
        self.assertEqual(
            vespa_doc["fields"]["marqo__score_modifiers_double_long"][
                "map_double_field.double_field"
            ],
            4.56,
        )
        ...
        self.assertEqual(
            vespa_doc["fields"]["marqo__score_modifiers"]["float_field"], 1.23
        )
        self.assertEqual(
            vespa_doc["fields"]["marqo__score_modifiers"]["double_field"], 4.56
        )
        self.assertEqual(
            vespa_doc["fields"]["marqo__score_modifiers"][
                "map_float_field.float_field"
            ],
            1.23,
        )
    ...
    def test_unstructured_from_marqo_document(self):
        ...
        self.assertEqual(
            document.fields.score_modifiers_fields["double_field"], 4.56e39
        )
        self.assertEqual(
            document.fields.score_modifiers_fields["map_double_field.double_field"],
            4.56e39,
        )
        self.assertEqual(
            document.fields.score_modifiers_fields["map_float_field.float_field"], 1.23
        )
