...
class TestSearchStructured(MarqoTestCase):
        ...
        self.add_documents(
            ...
            add_docs_params=AddDocsParams(
                ...
                docs=[
                    ...
                    {"_id": "2", "text_field_1": "defgh", "text_field_2": "on the mat"},
                ],
            ),
        )
        ...
        self.add_documents(
            ...
            add_docs_params=AddDocsParams(
                ...
                docs=[
                    ...
                    {"_id": "9000", "text_field_1": "somewhat match"},
                ],
            ),
        )
    ...
    def test_lexical_filtering(self):
        ...
        test_parameters = [
            (
                "(bool_field_1:true AND float_field_1:[0.1 TO 0.75]) AND text_field_3:(other things)",
                1,
                "123456",
            ),
            (
                ...
                0,
                None,
            ),  # Assuming 'my_looLoo' is renamed to 'text_field_8'
    ...
    def test_attributes_to_retrieve(self):
        ...
        test_cases = (
            ...
            + tuple(
                ...
                for random_fields in [
                    random.sample(doc.keys(), random.randint(2, len(doc)))
                    for _ in range(10)
                ]
            )
        )  # random n(>1) fields, 10 times
    ...
    def test_limit_results(self):
        ...
        res = self.add_documents(
            ...
            add_docs_params=AddDocsParams(
                ...
                docs=[
                    {
                        "text_field_1": "a test of"
                        + (" ".join(random.choices(population=vocab, k=10)))
                    }
                    for _ in range(128)
                ],
    ...
    def test_image_search_highlights(self):
        ...
        assert {hit["_highlights"][0]["image_field_1"] for hit in res["hits"]} == {
            url_2,
            url_1,
        }
    ...
    def test_lexical_search_with_required_terms_results(self):
        ...
        test_cases = [
            ...
            (
                ...
                ["text_field_4"],
                ["2"],
            ),  # phrase match restricted to field
            ...
            (
                ...
                ["text_field_4"],
                [],
            ),  # valid term excluded due to field filter
        ...
        for query, searchable_attributes, expected_docs_ids in test_cases:
            with self.subTest(f"{query}, {searchable_attributes}, {expected_docs_ids}"):
                ...
                self.assertEqual(
                    set(expected_docs_ids), {hit["_id"] for hit in res["hits"]}
                )
