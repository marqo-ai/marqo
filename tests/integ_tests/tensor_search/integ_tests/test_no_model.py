...
class TestNoModel(MarqoTestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        structured_index_with_no_model_request = cls.structured_marqo_index_request(
            ...
            model=Model(
                name="no_model",
                properties={"dimensions": cls.DIMENSION, "type": "no_model"},
                custom=True,
            ),
            fields=[
    ...
    def test_create_index_with_invalid_model_properties(self):
        ...
        try:
            self.index_management.delete_index_by_name(
                "test_create_index_with_invalid_model_name_or_properties"
            )
        ...
        for index_name in [
            ...
            with self.subTest(index_name=index_name):
                tensor_fields = (
                    ...
                    if index_name == self.unstructured_index_with_no_model
                    else None
                )
                mappings = (
