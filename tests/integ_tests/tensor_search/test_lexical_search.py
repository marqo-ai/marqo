...
class TestLexicalSearch(MarqoTestCase):
    ...
    def test_lexical_search_empty_text(self):
        self.add_documents(
            ...
            add_docs_params=AddDocsParams(
                ...
                docs=[{"some doc 1": "some field 2", "some doc 2": "some other thing"}],
                auto_refresh=True,
                device="cpu",
            ),
        )
    ...
    def test_lexical_search_no_index(self):
        try:
            res = tensor_search._lexical_search(
                config=self.config, index_name="non existent index", text="abcdefg"
            )
        except IndexNotFoundError:
            pass
    ...
    def test_lexical_search_single_searchable_attribs(self):
        ...
        d1 = {"title": "Marqo", "some doc 2": "some other thing", "_id": "abcdef"}
        d2 = {
            "some doc 1": "some 2 jnkerkbj",
            "field abc": "robodog is not a cat",
            "_id": "Jupyter_12",
        }
        d3 = {
            "TITITLE": "Tony from the way",
            "field lambda": "some prop field called marqo",
            "_id": "122",
        }
        d4 = {
            "Lucy": "Travis",
            "field lambda": "there is a whole bunch of text here. "
        ...
        res = tensor_search._lexical_search(
            ...
            index_name=self.index_name_1,
            text="marqo field",
            searchable_attributes=["field lambda"],
            result_count=3,
        )
        assert len(res["hits"]) == 2
    ...
    def test_lexical_search_multiple_searchable_attribs(self):
        ...
        d1 = {
            "FIELD omega": "Marqo which has many fields ",
            "field lambda": "field",
            "_id": "abcdef",
        }
        d2 = {
    ...
    def test_lexical_search_result_count(self):
        ...
        d4 = {
            "Lucy": "Travis",
            "field lambda": "there is a whole bunch of text here. Some other text. "
    ...
    def test_lexical_search_overwriting_doc(self):
        ...
        self.add_documents(
            config=self.config,
            add_docs_params=AddDocsParams(
                index_name=self.index_name_1, auto_refresh=True, docs=[d0], device="cpu"
            ),
        )
        assert (
            []
            == tensor_search._lexical_search(
                config=self.config, index_name=self.index_name_1, text="Marqo field"
            )["hits"]
        )
        ...
        self.add_documents(
            config=self.config,
            add_docs_params=AddDocsParams(
                index_name=self.index_name_1, auto_refresh=True, docs=[d1], device="cpu"
            ),
        )
    ...
    def test_lexical_search_empty_searchable_attribs(self):
        ...
        d2 = {
            "some doc 1": "some 2 jnkerkbj",
            "field abc": "extravagant robodog is not a cat",
            "_id": "Jupyter_12",
        }
    ...
    def test_lexical_search_double_quotes(self):
        ...
        cases = [
            ...
            {
                "input": '"gender is female" "random"',
                "required_terms": ["gender is female", "random"],
            },
            {
            ...
            {
                "input": '"accessory is none"',
                "required_terms": ["accessory is none"],
            },  # Multi-field testing
            # Escaped quotes
            {
            ...
            {
                "input": '"fake term" is required, this should yield no results',
                "no_results": True,
            },
    ...
    def test_lexical_search_list(self):
        self.add_documents(
            ...
            add_docs_params=AddDocsParams(
                ...
                auto_refresh=True,
                non_tensor_fields=["my_list", "fun list", "my_cool_list"],
                device="cpu",
            ),
        )
        base_search_args = {
    ...
    def test_lexical_search_filter_with_dot(self):
                ...
                docs=[
                    {
                        ...
                        "filename": "Important_File_1.pdf",
                        "_id": "123",
                    },
                    {
                        "content": "the horse is eating grass",
                        "filename": "Important_File_2.pdf",
                        "_id": "456",
                    },
                    {
                        "content": "what is the document",
                        "filename": "Important_File_3.pdf",
                        "_id": "789",
                    },
                ],
                auto_refresh=True,
        ...
        res = tensor_search._lexical_search(
            ...
            filter_string='filename: "Important_File_1.pdf"',
            result_count=8,
        )
        ...
        assert len(res["hits"]) == 3, (
            "this is a bug at the moment. the filter is not applied. "
