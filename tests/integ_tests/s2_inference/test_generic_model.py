...
class TestGenericModelSupport(MarqoTestCase):
    ...
    def test_validate_model_properties_missing_properties(self):
        ...
        model_name = "test"
        registry_test_model_properties = {
    ...
    def test_validate_model_properties_unknown_model_error(self):
        ...
        self.assertRaises(
            UnknownModelError, validate_model_properties, model_name, model_properties
        )
    ...
    def test_vectorise_with_default_model_different_properties(self):
        ...
        res_default = vectorise(
            model_name=model_name,
            model_properties=model_properties_default,
            content=content,
            device="cpu",
        )
        res_custom = vectorise(
            model_name="custom-model",
            model_properties=model_properties_custom,
            content=content,
            device="cpu",
        )
