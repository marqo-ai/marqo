...
from marqo.s2_inference.errors import ModelLoadError, UnknownModelError
...
class TestGenericModelSupport(MarqoTestCase):
    ...
    def test_create_index_and_add_documents_with_generic_open_clip_model_properties_url(
        self,
    ):
        ...
        assert tensor_search.get_document_by_id(
            config=self.config, index_name=self.index_name_1, document_id="321"
        ) == {
            "_id": "321",
            "title 1": "test test test",
            "desc 2": "test again test again test again",
    ...
    def test_pipeline_with_generic_openai_clip_model_properties_url(self):
        ...
        assert tensor_search.get_document_by_id(
            config=self.config, index_name=self.index_name_2, document_id="123"
        ) == {
            "_id": "123",
            "title 1": "content 1",
            "desc 2": "content 2. blah blah blah",
        ...
        assert tensor_search.get_document_by_id(
            config=self.config, index_name=self.index_name_2, document_id="321"
        ) == {
            "_id": "321",
            "title 1": "test test test",
            "desc 2": "test again test again test again",
    ...
    def test_vectorise_generic_openai_clip_encode_image_results(self):
        ...
        a = vectorise(
            model_name, content=image, model_properties=model_properties, device="cpu"
        )
    ...
    def test_vectorise_generic_openai_clip_encode_text_results(self):
        ...
        a = vectorise(
            model_name, content=text, model_properties=model_properties, device="cpu"
        )
    ...
    def test_vectorise_generic_open_clip_encode_image_results(self):
        ...
        b = vectorise(
            "open_clip/ViT-B-32-quickgelu/laion400m_e31", content=image, device="cpu"
        )
    ...
    def test_vectorise_generic_open_clip_encode_text_results(self):
        ...
        b = vectorise(
            "open_clip/ViT-B-32-quickgelu/laion400m_e31", content=text, device="cpu"
        )
    ...
    def test_incorrect_vectorise_generic_open_clip_encode_text_results(self):
        ...
        b = vectorise(
            "open_clip/ViT-B-32-quickgelu/laion400m_e32", content=text, device="cpu"
        )
