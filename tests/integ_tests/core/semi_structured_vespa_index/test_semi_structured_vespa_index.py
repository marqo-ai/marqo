...
from marqo.core.models import MarqoLexicalQuery, MarqoTensorQuery
...
class TestSemiStructuredVespaIndexToVespaQuery(unittest.TestCase):
    def test_to_vespa_query_should_include_static_fields_when_attributes_to_retrieve_is_not_empty(
        self,
    ):
        marqo_index = self._semi_structured_marqo_index(
            name="index1", lexical_field_names=["title"], tensor_field_names=["title"]
        )
    ...
    def test_to_vespa_query_should_include_string_array_fields_when_string_array_attributes_to_retrieve_is_not_empty(
        self,
    ):
        ...
        marqo_index = self._semi_structured_marqo_index(
            ...
            string_array_fields=["string_array_field1", "string_array_field2"],
        )
        vespa_index = SemiStructuredVespaIndex(marqo_index)
                ...
                self.assertSetEqual(
                    {
                        ...
                        "string_array_field1",
                        "string_array_field2",
                        "marqo__string_array_string_array_field1",
                        "marqo__string_array_string_array_field2",
                    },
                    fields,
                )

    def test_to_vespa_query_should_include_static_fields_when_attributes_to_retrieve_is_not_empty_pre_2_16_indexes(
        self,
    ):
        """
    ...
    def test_to_vespa_query_should_not_include_static_fields_when_attributes_to_retrieve_is_empty(
        self,
    ):
        marqo_index = self._semi_structured_marqo_index(
            name="index1", lexical_field_names=["title"], tensor_field_names=["title"]
