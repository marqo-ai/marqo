    ...
    def test_to_vespa_document_standardMarqoDoc_successful(self):
        ...
        expected_vespa_doc = {
            ...
            "fields": {
                ...
                "description": "my description",
                self.marqo_index.field_map[
                    "category"
                ].lexical_field_name: "my category",
                ...
                "price": 100.0,
                "rank": 1,
                self.marqo_index.field_map["click_per_day"].filter_field_name: [
                    1,
                    2,
                    3,
                ],
                self.marqo_index.field_map["last_updated"].filter_field_name: [
                    1.0,
                    2.0,
                    3.0,
                ],
                self.marqo_index.tensor_field_map["title"].chunk_field_name: [
                    "my",
                    "title",
                ],
    ...
    def test_to_vespa_document_fieldNotInIndex_fails(self):
        ...
        with self.assertRaises(core_exceptions.InvalidFieldNameError):
            self.vespa_index.to_vespa_document(
                {"_id": "my_id", "title": "my title", "nonexistent field": "fail"}
            )
