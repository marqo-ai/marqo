...
class TestStructuredIndexBuildLexicalSearchQuery(MarqoTestCase):
    ...
    def _help_create_test_lexical_query_object(
        self,
        or_phrases: List[str],
    ...
    def test_generate_and_terms_for_lexical_search(self):
        ...
        test_cases = [
            ...
            (
                ["required_1", "required_2"],
                ["lexical_field_1", "lexical_field_2"],
                '(marqo__lexical_lexical_field_1 contains "required_1" '
            ...
            (
                ["long required phrase", "short required phrase"],
                ["lexical_field_1", "lexical_field_4"],
            ...
            (
                ...
                ["lexical_field_1", "lexical_field_2", "lexical_field_3"],
