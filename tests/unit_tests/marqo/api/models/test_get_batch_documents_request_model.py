    ...
    def test_valid_get_batch_documents_request_model(self):
        test_cases = [
            ...
            (
                ...
                [f"id{i}" for i in range(1000)],
                "valid input with 1000 ids",
            ),
            (
                ["id1", 1],
                ["id1", "1"],
                "A valid one as Pydantic will coerce the int to str",
            ),
            (
                {
                    "id1",
                ...
                ["id1"],
                "A valid one as Pydantic will coerce the set to list",
            ),
        ]
        ...
        for document_ids, expected_document_ids, msg in test_cases:
            with self.subTest(msg=msg):
                ...
                aliased_model = GetBatchDocumentsRequest(
