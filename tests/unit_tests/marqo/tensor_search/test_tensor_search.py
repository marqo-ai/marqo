...
class TestGetPreprocessingConfig(MarqoTestCase):
    ...
    @patch.dict('os.environ', {'MARQO_IMAGE_DOWNLOAD_TIMEOUT_MS': '7500'})
    def test_image_preprocessing_config_uses_env_var_for_download_timeout(self):
    ...
    def test_image_preprocessing_config_default_timeout(self):
    ...
    def test_audio_preprocessing_config(self):
        """Test that AUDIO modality returns AudioPreprocessingConfig with correct defaults."""
        ...
        self.assertEqual(config.max_media_size_bytes, 387973120)

    def test_video_preprocessing_config(self):
        """Test that VIDEO modality returns VideoPreprocessingConfig with correct defaults."""
