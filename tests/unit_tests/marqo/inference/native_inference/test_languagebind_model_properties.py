...
class TestLanguagebindModelProperties(unittest.TestCase):
    def test_supported_modalities(self):
        ...
        test_cases = [
            (
                {"supportedModalities": [Modality.TEXT], **base_test_case},
                "Must support one of audio, image, video",
            ),
            (
                {"supportedModalities": [Modality.IMAGE], **base_test_case},
                "Text modality is required",
            ),
            (
                {"supportedModalities": ["text1"], **base_test_case},
                "Invalid modality, must be one of 'text', 'image', 'audio', 'video'",
            ),
            (
                {"supportedModalities": [None], **base_test_case},
                "Invalid modality, can't be None",
            ),
            (
                {"supportedModalities": [], **base_test_case},
                "Invalid modality, can't be empty",
            ),
            (
                {"supportedModalities": {}, **base_test_case},
                "Invalid data type, must be a list",
            ),
        ]
    ...
    def test_name_or_model_location_must_be_provided(self):
        ...
        test_cases = [
            (
                {**base_test_case},
                "One of name or modelLocation must be provided. Neither provided",
            ),
            (
    ...
    def test_valid_model_properties(self):
        ...
        valid_model_properties_list = [
            (
                ...
                "Custom model with image modality from URL",
            ),
            (
                {
                ...
                "Custom model with video modality from Hugging Face",
            ),
            (
                {
                    "supportedModalities": [
                ...
                "A mixture of all modalities and tokenizers from different locations",
            ),
            (
                {
                    "supportedModalities": [Modality.TEXT, Modality.IMAGE],
                ...
                "Marqo registered model with name",
            ),
        ]
    ...
    def test_model_location_exactly_one_field(self):
        ...
        for test_case, msg in test_cases:
            with self.subTest(msg=msg):
                ...
                self.assertIn(
                    "Exactly one of url, s3, hf must be provided",
                    str(context.exception),
                )
    ...
    def test_both_text_and_language_are_accepted_as_supported_modalities(self):
        ...
        test_cases = [
            (
                {"supportedModalities": ["text", "image"], **base_model_properties},
                "Text modality is accepted",
            ),
            (
                {"supportedModalities": ["language", "image"], **base_model_properties},
                "Language modality is accepted",
            ),
        ]
