            ...
            [
                {
                    ...
                    "allFields": [
                        ...
                        {"name": "non_tensor", "type": "text"},
                        {
                            ...
                            "dependentFields": {"title": 0.5, "content": 0.5},
                        },
                    ],
                ...
                },
                {
                    ...
                    "allFields": [
                        ...
                        {"name": "non_tensor", "type": "text"},
                        {
                            "name": "my_multi_modal_field",
                            "type": "multimodal_combination",
                            "dependentFields": {"title": 0.5, "image_content": 0.5},
                        },
                    ],
        ...
        for (
            ...
            with self.subTest(msg):
                self.client.index(self.text_index_name).add_documents(
                    documents=documents, device="cpu", mappings=mappings
                )
        ...
        test_cases = [
            (
                [
                    ...
                    {
                        "image_content": image_content
                    },  # 2 vectors (with multimodal_field)
                    {"non_tensor": "test"},  # 0 vector
                ],
                None,
                5,
