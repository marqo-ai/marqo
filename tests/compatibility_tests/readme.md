...
9. When writing tests, make sure to create an index with a unique name (defined in settings dict), such that it does not conflict with other tests that are running at the same time.
10. Every test case should be in a new .py file.