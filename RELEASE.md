...
## New features 
- Multimodal tensor combination (https://github.com/marqo-ai/marqo/pull/332). Multimodal combination objects can be added as a Marqo field. Use this to encode text metadata into image vectors.
