# Release 2.0.0
## New features
* Significant queries-per-second (QPS), latency improvements in addition to reduced memory and storage requirements. 
...
* Significantly improved recall. You can now get up to 99% recall without 
sacrificing performance (depending on your dataset and configuration).
...
[add documents](https://docs.marqo.ai/2.0.0/API-Reference/Documents/add_or_replace_documents/) for examples.
* New Marqo configuration parameters. See [here](https://docs.marqo.ai/2.0.0/Guides/Advanced-Usage/configuration/) for 
usage.
* Search response `_highlights` attribute is now a list of dictionaries. See [here](https://docs.marqo.ai/2.0.0/API-Reference/Search/search/#response-200-ok) for new usage.
