...
We move the health check under the index API to make it more intuitive to use. The old health check endpoint `client.health()` is deprecated and will be removed in the future version. See [here](https://docs.marqo.ai/1.0.0/API-Reference/health/) for detailed usage.
