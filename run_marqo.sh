...
memray run --out /opt/var/memray/memray.bin --trace-python-allocators --follow-fork --native -m uvicorn api:app --host 0.0.0.0 --port 8882 --timeout-keep-alive 75 --log-level $MARQO_LOG_LEVEL &export api_pid=$!
wait "$api_pid"
