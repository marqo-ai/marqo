...
if __name__ == '__main__':
    ...
    marqo_query = MarqoTensorQuery(
        ...
        attributes_to_retrieve=['title', 'description', 'image'],
        score_modifiers=[
            ScoreModifier(field='price', type=ScoreModifierType.Multiply, weight=0.5),
            ScoreModifier(field='rank', type=ScoreModifierType.Add, weight=0.5)
        ],
        expose_facets=False,
