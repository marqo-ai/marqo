...
FIELD_SCORE_MODIFIERS_2_8 = (
    "marqo__score_modifiers"  # retain for backwards compatibility
)
...
RANK_PROFILE_HYBRID_BM25_THEN_EMBEDDING_SIMILARITY = (
    "hybrid_bm25_then_embedding_similarity"
)
RANK_PROFILE_HYBRID_EMBEDDING_SIMILARITY_THEN_BM25 = (
