...
class StructuredVespaIndex(VespaIndex):
    ...
    def to_marqo_document(
        ...
        # be sure to default a hybrid score to 0 if it is not present
        if constants.MARQO_DOC_HYBRID_LEXICAL_SCORE in marqo_document or constants.MARQO_DOC_HYBRID_TENSOR_SCORE in marqo_document:
            marqo_document[constants.MARQO_DOC_HYBRID_LEXICAL_SCORE] = marqo_document.get(
                constants.MARQO_DOC_HYBRID_LEXICAL_SCORE, 0)
            marqo_document[constants.MARQO_DOC_HYBRID_TENSOR_SCORE] = marqo_document.get(
                constants.MARQO_DOC_HYBRID_TENSOR_SCORE, 0)
