    ...
    def search(
        ...
        if isinstance(marqo_index, StructuredMarqoIndex) and \
            ...
            raise core_exceptions.UnsupportedFeatureError(
                ...
                f"{constants.MARQO_STRUCTURED_HYBRID_SEARCH_MINIMUM_VERSION.__str__()} or later. "
            ...
            raise core_exceptions.UnsupportedFeatureError(
                ...
                f"{constants.MARQO_UNSTRUCTURED_HYBRID_SEARCH_MINIMUM_VERSION.__str__()} or later. "
                f"This index was created with Marqo {marqo_index_version}."
            )
