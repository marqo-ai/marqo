...
from marqo.core.models.marqo_index import FieldType, SemiStructuredMarqoIndex, FieldFeature, Field, TensorField, MarqoIndex
from marqo.core.models.marqo_index_request import SemiStructuredMarqoIndexRequest
...
class SemiStructuredVespaSchema(VespaSchema):
    ...
    def _generate_document_section(self, schema_name: str) -> (List[str], SemiStructuredMarqoIndex):
        """
    ...
    def _generate_rank_profiles(self, marqo_index: SemiStructuredMarqoIndex) -> List[str]:
    ...
    def _generate_default_fieldset(self, marqo_index: SemiStructuredMarqoIndex) -> List[str]:
    ...
    def _generate_summaries(self, marqo_index: SemiStructuredMarqoIndex) -> List[str]:
