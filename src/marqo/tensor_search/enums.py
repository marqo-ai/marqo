...
class EnvVars:
    ...
    VESPA_ASYNC_POOL_SIZE = "VESPA_ASYNC_POOL_SIZE"
    ...
    MARQO_CONCURRENCY_LIMIT_PER_GET_REQUEST = "MARQO_CONCURRENCY_LIMIT_PER_GET_REQUEST"
    ...
    MARQO_VESPA_SLOW_QUERY_THRESHOLD_MS = "MARQO_VESPA_SLOW_QUERY_THRESHOLD_MS"
    MARQO_VESPA_LOG_QUERY_DETAILS = "MARQO_VESPA_LOG_QUERY_DETAILS"
