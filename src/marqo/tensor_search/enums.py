...
class EnvVars:
    ...
    MARQO_TRITON_URL= "MARQO_TRITON_URL"
    MARQO_TRITON_GRPC_CLIENT_CONFIGS = "MARQO_TRITON_GRPC_CLIENT_CONFIGS"
    MARQO_MODEL_MANAGEMENT_CONTAINER_URL = "MARQO_MODEL_MANAGEMENT_CONTAINER_URL"
