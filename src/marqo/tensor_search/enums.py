...
class EnvVars:
    ...
    MARQO_OPENSEARCH_MAX_INDEX_RETRY_ATTEMPTS = "MARQO_OPENSEARCH_MAX_INDEX_RETRY_ATTEMPTS"
    MARQO_OPENSEARCH_MAX_INDEX_RETRY_BACKOFF = "MARQO_OPENSEARCH_MAX_INDEX_RETRY_BACKOFF"
