...
class EnvVars:
    ...
    MARQO_OPENSEARCH_MAX_SEARCH_RETRY_ATTEMPTS = "MARQO_OPENSEARCH_MAX_SEARCH_RETRY_ATTEMPTS"
    MARQO_OPENSEARCH_MAX_SEARCH_RETRY_BACKOFF = "MARQO_OPENSEARCH_MAX_SEARCH_RETRY_ATTEMPTS"
    MARQO_OPENSEARCH_MAX_ADD_DOCS_RETRY_ATTEMPTS = "MARQO_OPENSEARCH_MAX_ADD_DOCS_RETRY_ATTEMPTS"
    MARQO_OPENSEARCH_MAX_ADD_DOCS_RETRY_BACKOFF = "MARQO_OPENSEARCH_MAX_ADD_DOCS_RETRY_BACKOFF"
