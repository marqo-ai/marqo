...
class LanguagebindModelInferencePipeline(AbstractInferencePipeline):
    ...
    def run_pipeline(self) -> InferenceResult:
        preprocessed_content_list: List[LanguagebindPreprocessedContent] = (
    ...
    def _encode_processed_content(
        self, preprocessed_content_list: List[LanguagebindPreprocessedContent]
    ) -> List[ndarray]:
        """
    ...
    def _collect_valid_content_to_encode(
        self, preprocessed_content: list[LanguagebindPreprocessedContent]
    ) -> list[Tensor]:
        """
