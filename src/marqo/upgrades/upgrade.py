...
class UpgradeRunner:
    ...
    def upgrade(self):
        ...
        parsed_version = semver.VersionInfo.parse(
            config_version_full, optional_minor_and_patch=True
        )
...
class RollbackRunner:
    ...
    def rollback(self, from_version: str, to_version: str):
        parsed_from_version = semver.VersionInfo.parse(
            from_version, optional_minor_and_patch=True
        )
        parsed_to_version = semver.VersionInfo.parse(
            to_version, optional_minor_and_patch=True
        )
