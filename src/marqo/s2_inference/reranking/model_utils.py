...
def load_sbert_cross_encoder_model(model_name: str, device: str = 'cpu', max_length: int = 512) -> Dict:
    ...
    if model_cache_key in available_models:
        ...
        available_models[model_cache_key] ={"model": model, "most_recently_used_time" : datetime.datetime.now()}
...
def load_hf_cross_encoder_model(model_name: str, device: str = 'cpu') -> Dict:
    ...
    if model_cache_key in available_models:
        ...
        available_models[model_cache_key] = {"model":(model, tokenizer), "most_recently_used_time": datetime.datetime.now()}
...
def load_owl_vit(model_name: str, device: str = 'cpu') -> Dict:
    ...
    if model_cache_key in available_models:
        ...
        available_models[model_cache_key] = {"model": (model, processor), "most_recently_used_time" : datetime.datetime.now()}
