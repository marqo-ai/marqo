...
def chunk_image(image: Union[str, ImageType], device: str, 
                        ...
                        size=get_default_size()) -> Tuple[List[ImageType], List[List[float]]]:
    """_summary_
    ...
    Returns:
        Tuple[List[ImageType], List[List[float]: list of PIL images and the corresponding bounding boxes
    """
