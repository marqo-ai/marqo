...
def _get_open_clip_properties() -> Dict:
    ...
    OPEN_CLIP_MODEL_PROPERTIES = {
        'open_clip/RN101-quickgelu/openai': {'dimensions': 512,
                                             ...
                                             'pretrained': 'openai',
                                             'type': 'open_clip'},
        'open_clip/RN101-quickgelu/yfcc15m': {'dimensions': 512,
                                              'name': 'open_clip/RN101-quickgelu/yfcc15m',
                                              'note': 'open_clip models',
                                              'pretrained': 'yfcc15m',
                                              'type': 'open_clip'},
        'open_clip/RN101/openai': {'dimensions': 512,
                                   'name': 'open_clip/RN101/openai',
                                   'note': 'open_clip models',
                                   'pretrained': 'openai',
                                   'type': 'open_clip'},
        'open_clip/RN101/yfcc15m': {'dimensions': 512,
                                    'name': 'open_clip/RN101/yfcc15m',
                                    'note': 'open_clip models',
                                    'pretrained': 'yfcc15m',
                                    'type': 'open_clip'},
        'open_clip/RN50-quickgelu/cc12m': {'dimensions': 1024,
                                           'name': 'open_clip/RN50-quickgelu/cc12m',
                                           'note': 'open_clip models',
                                           'pretrained': 'cc12m',
                                           'type': 'open_clip'},
        'open_clip/RN50-quickgelu/openai': {'dimensions': 1024,
                                            'name': 'open_clip/RN50-quickgelu/openai',
                                            'note': 'open_clip models',
                                            'pretrained': 'openai',
                                            'type': 'open_clip'},
        'open_clip/RN50-quickgelu/yfcc15m': {'dimensions': 1024,
                                             'name': 'open_clip/RN50-quickgelu/yfcc15m',
                                             'note': 'open_clip models',
                                             'pretrained': 'yfcc15m',
                                             'type': 'open_clip'},
        'open_clip/RN50/cc12m': {'dimensions': 1024,
                                 'name': 'open_clip/RN50/cc12m',
                                 'note': 'open_clip models',
                                 'pretrained': 'cc12m',
                                 'type': 'open_clip'},
        'open_clip/RN50/openai': {'dimensions': 1024,
                                  'name': 'open_clip/RN50/openai',
                                  'note': 'open_clip models',
                                  'pretrained': 'openai',
                                  'type': 'open_clip'},
        'open_clip/RN50/yfcc15m': {'dimensions': 1024,
                                   'name': 'open_clip/RN50/yfcc15m',
                                   'note': 'open_clip models',
                                   'pretrained': 'yfcc15m',
                                   'type': 'open_clip'},
        'open_clip/RN50x16/openai': {'dimensions': 768,
                                     'name': 'open_clip/RN50x16/openai',
                                     'note': 'open_clip models',
                                     'pretrained': 'openai',
                                     'type': 'open_clip'},
        'open_clip/RN50x4/openai': {'dimensions': 640,
                                    'name': 'open_clip/RN50x4/openai',
                                    'note': 'open_clip models',
                                    'pretrained': 'openai',
                                    'type': 'open_clip'},
        'open_clip/RN50x64/openai': {'dimensions': 1024,
                                     'name': 'open_clip/RN50x64/openai',
                                     'note': 'open_clip models',
                                     'pretrained': 'openai',
                                     'type': 'open_clip'},
        'open_clip/ViT-B-16-plus-240/laion400m_e31': {'dimensions': 640,
                                                      'name': 'open_clip/ViT-B-16-plus-240/laion400m_e31',
                                                      'note': 'open_clip models',
                                                      'pretrained': 'laion400m_e31',
                                                      'type': 'open_clip'},
        'open_clip/ViT-B-16-plus-240/laion400m_e32': {'dimensions': 640,
                                                      'name': 'open_clip/ViT-B-16-plus-240/laion400m_e32',
                                                      'note': 'open_clip models',
                                                      'pretrained': 'laion400m_e32',
                                                      'type': 'open_clip'},
        'open_clip/ViT-B-16/laion2b_s34b_b88k': {'dimensions': 512,
                                                 'name': 'open_clip/ViT-B-16/laion2b_s34b_b88k',
                                                 'note': 'open_clip models',
                                                 'pretrained': 'laion2b_s34b_b88k',
                                                 'type': 'open_clip'},
        'open_clip/ViT-B-16/laion400m_e31': {'dimensions': 512,
                                             'name': 'open_clip/ViT-B-16/laion400m_e31',
                                             'note': 'open_clip models',
                                             'pretrained': 'laion400m_e31',
                                             'type': 'open_clip'},
        'open_clip/ViT-B-16/laion400m_e32': {'dimensions': 512,
                                             'name': 'open_clip/ViT-B-16/laion400m_e32',
                                             'note': 'open_clip models',
                                             'pretrained': 'laion400m_e32',
                                             'type': 'open_clip'},
        'open_clip/ViT-B-16/openai': {'dimensions': 512,
                                      'name': 'open_clip/ViT-B-16/openai',
                                      'note': 'open_clip models',
                                      'pretrained': 'openai',
                                      'type': 'open_clip'},
        'open_clip/ViT-B-32-quickgelu/laion400m_e31': {'dimensions': 512,
                                                       'name': 'open_clip/ViT-B-32-quickgelu/laion400m_e31',
                                                       'note': 'open_clip models',
                                                       'pretrained': 'laion400m_e31',
                                                       'type': 'open_clip'},
        'open_clip/ViT-B-32-quickgelu/laion400m_e32': {'dimensions': 512,
                                                       'name': 'open_clip/ViT-B-32-quickgelu/laion400m_e32',
                                                       'note': 'open_clip models',
                                                       'pretrained': 'laion400m_e32',
                                                       'type': 'open_clip'},
        'open_clip/ViT-B-32-quickgelu/openai': {'dimensions': 512,
        ...
        'open_clip/ViT-B-32/laion2b_e16': {'dimensions': 512,
                                           ...
                                           'type': 'open_clip'},
        'open_clip/ViT-B-32/laion2b_s34b_b79k': {'dimensions': 512,
                                                 'name': 'open_clip/ViT-B-32/laion2b_s34b_b79k',
                                                 'note': 'open_clip models',
                                                 'pretrained': 'laion2b_s34b_b79k',
                                                 'type': 'open_clip'},
        'open_clip/ViT-B-32/laion400m_e31': {'dimensions': 512,
                                             'name': 'open_clip/ViT-B-32/laion400m_e31',
                                             'note': 'open_clip models',
                                             'pretrained': 'laion400m_e31',
                                             'type': 'open_clip'},
        'open_clip/ViT-B-32/laion400m_e32': {'dimensions': 512,
                                             'name': 'open_clip/ViT-B-32/laion400m_e32',
                                             'note': 'open_clip models',
                                             'pretrained': 'laion400m_e32',
                                             'type': 'open_clip'},
        'open_clip/ViT-B-32/openai': {'dimensions': 512,
                                      'name': 'open_clip/ViT-B-32/openai',
                                      'note': 'open_clip models',
                                      'pretrained': 'openai',
                                      'type': 'open_clip'},
        'open_clip/ViT-H-14/laion2b_s32b_b79k': {'dimensions': 1024,
                                                 'name': 'open_clip/ViT-H-14/laion2b_s32b_b79k',
                                                 'note': 'open_clip models',
                                                 'pretrained': 'laion2b_s32b_b79k',
                                                 'type': 'open_clip'},
        'open_clip/ViT-L-14-336/openai': {'dimensions': 768,
                                          'name': 'open_clip/ViT-L-14-336/openai',
                                          'note': 'open_clip models',
                                          'pretrained': 'openai',
                                          'type': 'open_clip'},
        'open_clip/ViT-L-14/laion2b_s32b_b82k': {'dimensions': 768,
                                                 'name': 'open_clip/ViT-L-14/laion2b_s32b_b82k',
                                                 'note': 'open_clip models',
                                                 'pretrained': 'laion2b_s32b_b82k',
                                                 'type': 'open_clip'},
        'open_clip/ViT-L-14/laion400m_e31': {'dimensions': 768,
                                             'name': 'open_clip/ViT-L-14/laion400m_e31',
                                             'note': 'open_clip models',
                                             'pretrained': 'laion400m_e31',
                                             'type': 'open_clip'},
        'open_clip/ViT-L-14/laion400m_e32': {'dimensions': 768,
                                             'name': 'open_clip/ViT-L-14/laion400m_e32',
                                             'note': 'open_clip models',
                                             'pretrained': 'laion400m_e32',
                                             'type': 'open_clip'},
        'open_clip/ViT-L-14/openai': {'dimensions': 768,
                                      'name': 'open_clip/ViT-L-14/openai',
                                      'note': 'open_clip models',
                                      'pretrained': 'openai',
                                      'type': 'open_clip'},
        'open_clip/ViT-bigG-14/laion2b_s39b_b160k': {'dimensions': 1280,
                                                     'name': 'open_clip/ViT-bigG-14/laion2b_s39b_b160k',
                                                     'note': 'open_clip models',
                                                     'pretrained': 'laion2b_s39b_b160k',
                                                     'type': 'open_clip'},
        'open_clip/ViT-g-14/laion2b_s12b_b42k': {'dimensions': 1024,
                                                 'name': 'open_clip/ViT-g-14/laion2b_s12b_b42k',
                                                 'note': 'open_clip models',
                                                 'pretrained': 'laion2b_s12b_b42k',
                                                 'type': 'open_clip'},
        'open_clip/coca_ViT-B-32/laion2b_s13b_b90k': {'dimensions': 512,
                                                      'name': 'open_clip/coca_ViT-B-32/laion2b_s13b_b90k',
                                                      'note': 'open_clip models',
                                                      'pretrained': 'laion2b_s13b_b90k',
                                                      'type': 'open_clip'},
        'open_clip/coca_ViT-B-32/mscoco_finetuned_laion2b_s13b_b90k': {'dimensions': 512,
                                                                       'name': 'open_clip/coca_ViT-B-32/mscoco_finetuned_laion2b_s13b_b90k',
                                                                       'note': 'open_clip models',
                                                                       'pretrained': 'mscoco_finetuned_laion2b_s13b_b90k',
                                                                       'type': 'open_clip'},
        'open_clip/coca_ViT-L-14/laion2b_s13b_b90k': {'dimensions': 768,
                                                      'name': 'open_clip/coca_ViT-L-14/laion2b_s13b_b90k',
                                                      'note': 'open_clip models',
                                                      'pretrained': 'laion2b_s13b_b90k',
                                                      'type': 'open_clip'},
        'open_clip/coca_ViT-L-14/mscoco_finetuned_laion2b_s13b_b90k': {'dimensions': 768,
                                                                       'name': 'open_clip/coca_ViT-L-14/mscoco_finetuned_laion2b_s13b_b90k',
                                                                       'note': 'open_clip models',
                                                                       'pretrained': 'mscoco_finetuned_laion2b_s13b_b90k',
                                                                       'type': 'open_clip'},
        'open_clip/convnext_base/laion400m_s13b_b51k': {'dimensions': 512,
                                                        'name': 'open_clip/convnext_base/laion400m_s13b_b51k',
                                                        'note': 'open_clip models',
                                                        'pretrained': 'laion400m_s13b_b51k',
                                                        'type': 'open_clip'},
        'open_clip/convnext_base_w/laion2b_s13b_b82k': {'dimensions': 640,
                                                        'name': 'open_clip/convnext_base_w/laion2b_s13b_b82k',
                                                        'note': 'open_clip models',
                                                        'pretrained': 'laion2b_s13b_b82k',
                                                        'type': 'open_clip'},
        'open_clip/convnext_base_w/laion2b_s13b_b82k_augreg': {'dimensions': 640,
                                                               'name': 'open_clip/convnext_base_w/laion2b_s13b_b82k_augreg',
                                                               'note': 'open_clip models',
                                                               'pretrained': 'laion2b_s13b_b82k_augreg',
                                                               'type': 'open_clip'},
        'open_clip/convnext_base_w/laion_aesthetic_s13b_b82k': {'dimensions': 640,
                                                                'name': 'open_clip/convnext_base_w/laion_aesthetic_s13b_b82k',
                                                                'note': 'open_clip models',
                                                                'pretrained': 'laion_aesthetic_s13b_b82k',
                                                                'type': 'open_clip'},
        'open_clip/convnext_base_w_320/laion_aesthetic_s13b_b82k': {'dimensions': 640,
                                                                    'name': 'open_clip/convnext_base_w_320/laion_aesthetic_s13b_b82k',
                                                                    'note': 'open_clip models',
                                                                    'pretrained': 'laion_aesthetic_s13b_b82k',
                                                                    'type': 'open_clip'},
        'open_clip/convnext_base_w_320/laion_aesthetic_s13b_b82k_augreg': {'dimensions': 640,
                                                                           'name': 'open_clip/convnext_base_w_320/laion_aesthetic_s13b_b82k_augreg',
                                                                           'note': 'open_clip models',
                                                                           'pretrained': 'laion_aesthetic_s13b_b82k_augreg',
                                                                           'type': 'open_clip'},
        'open_clip/convnext_large_d/laion2b_s26b_b102k_augreg': {'dimensions': 768,
                                                                 'name': 'open_clip/convnext_large_d/laion2b_s26b_b102k_augreg',
                                                                 'note': 'open_clip models',
                                                                 'pretrained': 'laion2b_s26b_b102k_augreg',
                                                                 'type': 'open_clip'},
        'open_clip/roberta-ViT-B-32/laion2b_s12b_b32k': {'dimensions': 512,
                                                         'name': 'open_clip/roberta-ViT-B-32/laion2b_s12b_b32k',
                                                         'note': 'open_clip models',
                                                         'pretrained': 'laion2b_s12b_b32k',
                                                         'type': 'open_clip'},
        'open_clip/xlm-roberta-base-ViT-B-32/laion5b_s13b_b90k': {'dimensions': 512,
                                                                  'name': 'open_clip/xlm-roberta-base-ViT-B-32/laion5b_s13b_b90k',
                                                                  'note': 'open_clip models',
                                                                  'pretrained': 'laion5b_s13b_b90k',
                                                                  'type': 'open_clip'},
        'open_clip/xlm-roberta-large-ViT-H-14/frozen_laion5b_s13b_b90k': {'dimensions': 1024,
