...
def _get_open_clip_properties() -> Dict:
    ...
    OPEN_CLIP_MODEL_PROPERTIES = {
        ...
        'open_clip/ViT-L-14/openai': {'name': 'open_clip/ViT-L-14/openai',
                                      ...
                                      'type': 'open_clip',
                                      'pretrained': 'openai'},
        'Marqo/ViT-L-14/openai': {'name': 'open_clip/ViT-L-14/openai',
                                      'dimensions': 768,
                                      'note': 'open_clip models',
                                      'type': 'open_clip',
                                      'pretrained': 'openai'},
        'open_clip/ViT-L-14/laion400m_e31': {'name': 'open_clip/ViT-L-14/laion400m_e31',
                                             ...
                                             'type': 'open_clip',
                                             'pretrained': 'laion400m_e31'},
        'Marqo/ViT-L-14/laion400m_e31': {'name': 'open_clip/ViT-L-14/laion400m_e31',
                                             'dimensions': 768,
                                             'note': 'open_clip models',
                                             'type': 'open_clip',
                                             'pretrained': 'laion400m_e31'},
        'open_clip/ViT-L-14/laion400m_e32': {'name': 'open_clip/ViT-L-14/laion400m_e32',
                                             ...
                                             'type': 'open_clip',
                                             'pretrained': 'laion400m_e32'},
        'Marqo/ViT-L-14/laion400m_e32': {'name': 'open_clip/ViT-L-14/laion400m_e32',
                                             'dimensions': 768,
                                             'note': 'open_clip models',
                                             'type': 'open_clip',
                                             'pretrained': 'laion400m_e32'},
        ...
        'Marqo/ViT-L-14/laion2b_s32b_b82k': {'name': 'open_clip/ViT-L-14/laion2b_s32b_b82k',
                                                 'dimensions': 768,
                                                 'note': 'open_clip models',
                                                 'type': 'open_clip',
                                                 'pretrained': 'laion2b_s32b_b82k'},
        ...
        'Marqo/roberta-ViT-B-32/laion2b_s12b_b32k': {'name': 'open_clip/roberta-ViT-B-32/laion2b_s12b_b32k',
                                                         'dimensions': 512,
                                                         'note': 'open_clip models',
                                                         'type': 'open_clip',
                                                         'pretrained': 'laion2b_s12b_b32k'},
