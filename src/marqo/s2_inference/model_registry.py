...
from marqo.s2_inference.clap_utils import LAION_CLAP
...
#         }
#     }
#     return MS_CLAP_MODEL_PROPERTIES
...
def load_model_properties() -> Dict:
    ...
    laion_clap_model_properties = _get_laion_clap_properties()
    # ms_clap_model_properties = _get_ms_clap_properties()
    ...
    # model_properties.update(ms_clap_model_properties)
    model_properties.update(laion_clap_model_properties)
