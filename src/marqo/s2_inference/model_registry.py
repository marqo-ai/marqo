...
def _get_open_clip_properties() -> Dict:
    ...
    OPEN_CLIP_MODEL_PROPERTIES = {
        ...
        "Marqo/ViT-L-14.openai": {
            "name": "hf-hub:timm/vit_large_patch14_clip_224.openai",
            "dimensions": 768,
            "note": "open_clip models",
            "type": "open_clip",
            "pretrained": "openai",
...
def load_model_properties() -> Dict:
    ...
    sbert_model_properties.update(
        {k.split("/")[-1]: v for k, v in sbert_model_properties.items()}
    )
