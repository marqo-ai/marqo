...
def multimodal_combination_object():
    return _build_url(
        "other-resources/guides/advanced-usage/document-fields/#multimodal-combination-object"
    )


def custom_vector_object():
    return _build_url(
        "other-resources/guides/advanced-usage/document-fields/#custom-vector-object"
    )
...
def configuring_preloaded_models():
    return _build_url(
        "other-resources/guides/advanced-usage/configuration/#configuring-preloaded-models"
    )
...
def hugging_face_trust_remote_code():
    return _build_url(
        "models/marqo/bring-your-own-model/#bring-your-own-hugging-face-sentence-transformers-models"
    )
