...
_MODEL_REGISTRY: dict[str, dict] = {
    "Marqo/marqo-fashionCLIP": {
        ...
        "tritonImageEncoderProperties": {
            ...
            "sources": [
                "s3://marqo-opensource-models/marqo-fashionCLIP/image-encoder/model.onnx"
            ],
            "input": [
        ...
        "tritonTextEncoderProperties": {
            ...
            "sources": [
                "s3://marqo-opensource-models/marqo-fashionCLIP/text-encoder/model.onnx"
            ],
    ...
    "Marqo/marqo-fashionSigLIP": {
        ...
        "tritonTextEncoderProperties": {
            ...
            "sources": [
                "s3://marqo-opensource-models/marqo-fashionSigLIP/text-encoder/model.onnx"
            ],
    ...
    "Marqo/marqo-ecommerce-embeddings-L": {
        ...
        "tritonImageEncoderProperties": {
            ...
            "sources": [
                "s3://marqo-opensource-models/marqo-ecommerce-embeddings-L/image-encoder/model.onnx"
            ],
            "input": [
        ...
        "tritonTextEncoderProperties": {
            ...
            "sources": [
                "s3://marqo-opensource-models/marqo-ecommerce-embeddings-L/text-encoder/model.onnx"
            ],
            "input": [{"name": "input", "dims": [64], "dataType": "TYPE_INT32"}],
            "output": [{"name": "output", "dims": [1024], "dataType": "TYPE_FP32"}],
        },
    ...
    "Marqo/marqo-ecommerce-embeddings-B": {
        ...
        "tritonImageEncoderProperties": {
            ...
            "sources": [
                "s3://marqo-opensource-models/marqo-ecommerce-embeddings-B/image-encoder/model.onnx"
            ],
            "input": [
                {"name": "input", "dims": [3, 224, 224], "dataType": "TYPE_FP32"}
            ],
        ...
        "tritonTextEncoderProperties": {
            ...
            "sources": [
                "s3://marqo-opensource-models/marqo-ecommerce-embeddings-B/text-encoder/model.onnx"
            ],
            "input": [{"name": "input", "dims": [64], "dataType": "TYPE_INT32"}],
            "output": [{"name": "output", "dims": [768], "dataType": "TYPE_FP32"}],
        },
    ...
    "timm/ViT-L-16-SigLIP2-256": {
        ...
        "tritonImageEncoderProperties": {
            ...
            "sources": [
                "s3://marqo-opensource-models/timm-ViT-L-16-SigLIP2-256/image-encoder/model.onnx"
            ],
            "input": [
                {"name": "input", "dims": [3, 256, 256], "dataType": "TYPE_FP32"}
            ],
    ...
    "open_clip/ViT-L-16-SigLIP-256/webli": {
        ...
        "tritonImageEncoderProperties": {
            ...
            "sources": [
                "s3://marqo-opensource-models/timm-ViT-L-16-SigLIP-256/image-encoder/model.onnx"
            ],
            "input": [
                {"name": "input", "dims": [3, 256, 256], "dataType": "TYPE_FP32"}
            ],
    ...
    "open_clip/ViT-L-14/laion2b_s32b_b82k": {
        ...
        "tritonImageEncoderProperties": {
            ...
            "sources": [
                "s3://marqo-opensource-models/laion-CLIP-ViT-L-14-laion2B-s32B-b82K/image-encoder/model.onnx"
            ],
            "input": [
                {"name": "input", "dims": [3, 224, 224], "dataType": "TYPE_FP32"}
            ],
    ...
    "open_clip/ViT-B-16-SigLIP/webli": {
        ...
        "tritonImageEncoderProperties": {
            ...
            "sources": [
                "s3://marqo-opensource-models/timm-ViT-B-16-SigLIP/image-encoder/model.onnx"
            ],
            "input": [
                {"name": "input", "dims": [3, 224, 224], "dataType": "TYPE_FP32"}
            ],
