...
from inference_orchestrator.services.triton_inference.embedding_models.random.random_model import RandomModel
...
class RandomModelInferencePipeline(AbstractInferencePipeline):
    ...
    def _encode_processed_content(self, preprocessed_content_list: List[RandomModelPreprocessedContent]) -> List[
        ndarray]:
        """
