...
from inference_orchestrator.services.errors import ImageDownloadError
...
def format_and_load_CLIP_images(images: List[Union[str, ndarray, Image, Tensor]],
                                media_download_headers: dict) -> Union[List[Image], List[Tensor]]:
...
def format_and_load_CLIP_image(image: Union[str, ndarray, Image, Tensor],
                               media_download_headers: dict) -> Union[Image, Tensor]:
...
def load_image_from_path(image_path: str, media_download_headers: dict, timeout_ms=3000,
                         metrics_obj: Optional[RequestMetrics] = None) -> Image:
