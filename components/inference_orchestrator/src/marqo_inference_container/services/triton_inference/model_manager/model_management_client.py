...
class ModelManagementClient:
    ...
    def unload_model(self, model_name: str, remove_files: bool = False, timeout: float = 60):
        self.client.post(url=f"{self.url}/v1/models/{model_name}/unload?remove-files={remove_files}", timeout=timeout)