...
- Development: `PYTHONPATH=./src python -m model_management.main`
...
1. **API Layer** (`src/model_management/api/`)
...
2. **Service Layer** (`src/model_management/service/`)
...
3. **Configuration** (`src/model_management/core/`)
