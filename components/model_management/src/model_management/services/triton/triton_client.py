...
class TritonClient:
    ...
    def load_model(self, model_name: str):
        try:
            ...
            raise TritonCommunicationError('Triton timed out when trying to load model ')
        ...
        try:
            ...
            raise TritonModelLoadError(f'Failed to load model. Original error: {res.json().get("error")}') from e
    ...
    def unload_model(self, model_name: str):
        try:
            ...
            raise TritonCommunicationError('Triton timed out when trying to unload model ')
        except (ConnectError, NetworkError) as e:
            raise TritonCommunicationError('Triton is unavailable') from e
